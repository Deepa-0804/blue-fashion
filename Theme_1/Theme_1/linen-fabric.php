                    ...
                    <div class="col-lg-12">
                        <div class="ttm-page-title-row-inner">
                            <div class="page-title-heading">
                                <h2 class="title">Linen Fabric</h2>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-lg-8">
                                                ...
                                                <div class="ttm_pf_image-wrapper">
                                                    <img class="img-fluid auto_size" src="images/web-shots/WOW03350C4.jpg" width="772" height="515" alt="portfolio-img">
                                            ...
                                            <div class="col-md-12 col-lg-4">
                                                <div class="ttm-pf-single-detail-box">
                                                    ...
                                                    <div class="ttm-short-desc">Linen fabric project delivers lightweight, breathable textiles offering natural comfort, durability, and timeless elegance for everyday wear.</div>
                                                    <ul class="ttm-pf-detailbox-list">
                                                        <li><span>Project: </span><span>Linen Materials </span></li>
                                                        <li><span>Category: </span><span>Linen</span></li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="margin_top40">
                                                    ...
                                                    <p>Our linen fabric project creates breathable, eco-friendly textiles that provide natural comfort and durability. Designed for elegance and versatility, our linen fabrics ensure a timeless, lightweight solution for stylish, everyday wear and sustainable living.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                <div class="ttm_single_image-wrapper text-start padding_top15">
                                                    <img class="img-fluid" src="images/web-shots/WOW00446C2.jpg" alt="single-img-10">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                                <div class="ttm_single_image-wrapper text-start padding_top15">
                                                    <img class="img-fluid" src="images/web-shots/WOW00394C2.jpg" alt="single-img-11">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="margin_top40">
                                            <h2>Results Our Client's Report</h2>
                                            <p>Results from our client's report showcase high satisfaction with our linen fabric, highlighting its breathable comfort, durability, and timeless elegance. Clients value its versatility and eco-friendly nature, praising it for creating stylish, lightweight garments suitable for both casual and formal occasions.</p>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
