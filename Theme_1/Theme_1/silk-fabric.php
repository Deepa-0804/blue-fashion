...
<!-- Mirrored from themetechmount.com/html/BlueFashion/demo4/silk-fabric.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Mar 2025 08:40:54 GMT -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-lg-8">
                                                ...
                                                <div class="ttm_pf_image-wrapper">
                                                    <img class="img-fluid" src="images/web-shots/WOW02917C3.jpg" alt="portfolio-img">
                                            ...
                                            <div class="col-md-12 col-lg-4">
                                                <div class="ttm-pf-single-detail-box">
                                                    ...
                                                    <div class="ttm-short-desc">Eco-friendly, durable fabric made from naturally sourced silt materials.</div>
                                                    <ul class="ttm-pf-detailbox-list">
                                                        <li><span>Project: </span><span>Silk Materials</span></li>
                                                        <li><span>Category: </span><span>Silk</span></li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="margin_top40">
                                                    ...
                                                    <p>our silk fabric project blends tradition with innovation.
                                                    We craft luxurious, sustainable textiles to enhance comfort and well-being. Experience the perfect harmony of nature and luxury in every thread.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                <div class="ttm_single_image-wrapper text-start padding_top15">
                                                    <img class="img-fluid" src="images/web-shots/WOW026162C.jpg" alt="single-img-10">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                                <div class="ttm_single_image-wrapper text-start padding_top15">
                                                    <img class="img-fluid" src="images/web-shots/WOW02793C.jpg" alt="single-img-11">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="margin_top40">
                                            <h2>Results Our Client's Report</h2>
                                            <p>Our clients report exceptional comfort and elegance with our silk fabrics.  
                                            They appreciate the premium quality, durability, and sustainable craftsmanship we deliver.</p>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
